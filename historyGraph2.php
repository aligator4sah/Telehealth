...
<section id="features" class="features">
    <div class="features__wrapper">
        ...
        <div class="features__elements-wrapper">
            ...
            echo "<form action = \"historyGraph2.php\" method = \"POST\">";
            ...
            if(isset($_POST["dateSubmit"])) {
                ...
                echo "<tr>";
                echo '<td> <a href = "vendorResult4.php"> Vendor Selection </a> </td>';
                echo '<td>' .$vendory. '</td>';
                echo '<td>' .$vendorn. '</td>';
                echo '<td>' .$vendord. '</td>';
                ...
                echo "<tr>";
                echo '<td> <a href= "patientResult4.php"> Patient Provider </a> </td>';
                echo '<td>' .$patienty. '</td>';
                echo '<td>' .$patientn. '</td>';
                echo '<td>' .$patientd. '</td>';
                echo '<td>' .$date_identification. '</td>';
                ...
                echo "<tr>";
                echo '<td> <a  href= "dataResult4.php"> Vendor Selection </a> </td>';
                echo '<td>' .$datay. '</td>';
                echo '<td>' .$datan. '</td>';
                echo '<td>' .$datad. '</td>';
                echo '<td>' .$date_identification. '</td>';
