		...
		<div class="hero__content">
			<div class="hero__content-wrapper">
				...
				<div class="hero__description">
					...
					<p style="text-align: right;"> <span class="psw"> <a href="adminlogin1.php">Log in as Administrator</a></span> </p>
				</div>
				<div class="hero__call-to-action">
					...
					<a href= "register1.php" class="hero__alt-button"> or Register</a>
				</div>
