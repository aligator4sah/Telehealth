...
Patient Provider Interaction Results
    </p></h1>     
    <?php
    ...
    if( $_POST ) {
      ...
      // need to obtain the data submitted from the form and store them into the database, then query to show the results
...
<h2><a href="BlankSurvey.php#top">Return to survey</a></h2>
