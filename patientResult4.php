    ...
    <div class="header__wrapper">
        ...
        <div class="header__social-icons">
            <ul class="w3-navbar w3-blue">
                <a href="vendorResult4.php"><h5>Vendor Selection</h5></a>
                <a > <h5> | </h5></a>
                <a href="patientResult4.php"><h5>Patient</h5></a>
                <a > <h5> | </h5></a>
                <a href="dataResult4.php"><h5> Data</h5></a>
        ...
        <div class="showcase">
            ...
            <div class="showcase__stage-wrapper">
				...
				WHERE answers.UserID = $userid AND answers.QuestionID = patient.QuestionID AND answers.curtime='$curtime'";
                    ...
                    <a href="historyGraph2.php" class="showcase__button  ghost-button  ghost-button--realizations">Back</a>
